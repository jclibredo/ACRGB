...
public class EmailSender {
    ...
    public ACRGBWSResult EmailSender(
        ...
        try {
            ...
            message.setContent(utility.EmailTemplate(email.getRecipient(), utility.GenerateRandomPassword(10)), "text/html");
            //updatemethods.UPDATEPASSCODE(dataSource, email.getRecipient().trim(), utility.GenerateRandomPassword(10));
