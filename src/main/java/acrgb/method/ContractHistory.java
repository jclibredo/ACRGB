...
public class ContractHistory {
    ...
    public ACRGBWSResult GetHCPNContract(final DataSource dataSource, final String hcpncode) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
        String tags = "INACTIVE";
    ...
    public ACRGBWSResult GetHCIContract(final DataSource dataSource, final String facilitycode) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
    ...
    public ACRGBWSResult GetPROContract(final DataSource dataSource, final String procode) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
    ...
    public ACRGBWSResult GetAllAPEXContract(final DataSource dataSource) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
    ...
    public ACRGBWSResult GetAllHCPNContract(final DataSource dataSource) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
...
//     GET ALL CONTRACT HISTORY OF PRO
    public ACRGBWSResult GetAllPROContract(final DataSource dataSource) {
        ACRGBWSResult result = utility.ACRGBWSResult();
        result.setMessage("");
        result.setResult("");
        result.setSuccess(false);
        try (Connection connection = dataSource.getConnection()) {
            ...
            while (resultset.next()) {
                ...
                ACRGBWSResult GetProContract = fm.GETALLCONTRACT(dataSource, "INACTIVE", procode.trim());
